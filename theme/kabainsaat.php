    ...
    <section id="box-listing" class="py-25">
        <div class="container">
            <div class="row">
                <?php for ($i = 1; $i <= 4; $i++): ?>
                    <div class="col-lg-6">
                        <a href="kabadetay.php" class="listing_item text-black block mb-8">
                            <div class="img p-5.5 bg-white mb-10">
                                <img src="<?= domain ?>assets/img/delete_project.webp" alt="Proje başlık"
                                    class="block w-full h-full object-cover object-center">
                            </div>
                            <span
                                class="block pl-17.5 relative before-absolute font-extrabold text-2xl leading-tight h">Proje
                                <?= $i ?> - 
                                <b class="font-semibold">Green Garden</b>
                            </span>
                        </a>
                    </div>
                <?php endfor; ?>
